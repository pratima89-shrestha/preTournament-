...
//       try {
//         const response = await fetch('http://localhost:3001/all-tour'); // Adjust your API endpoint
...
//     // Instead of using window.open, you can handle the join logic directly here
//     // Redirect to /QA when the button is clicked
//   };
...
const JoinTournament = ({ tournamentss }) => {
  ...
  const handleJoinClick = (tournament) => {
    setSelectedTournament(tournament); // Store selected tournament data
    // Navigate to the QA page with the tournament data
    navigate('/QA', { state: { tournament: tournament } });
  };
